...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2437554508ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjamanalat&table=user">`peminjamanalat`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjamanalat&table=pinjam">`peminjamanalat`.`pinjam`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjamanalat&table=lab">`peminjamanalat`.`lab`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjamanalat&table=barang">`peminjamanalat`.`barang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=trial&table=value">`trial`.`value`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pinjamalat&table=gudangbarang">`pinjamalat`.`gudangbarang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pinjamalat&table=pinjam">`pinjamalat`.`pinjam`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjamanalat&table=gudang">`peminjamanalat`.`gudang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjamanalat&table=instrukturlab">`peminjamanalat`.`instrukturlab`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mahasiswa&table=mahasiswa">`mahasiswa`.`mahasiswa`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="337a442524287866575c2b272d367847">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="peminjamanalat" targettable="user">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `user` (`User_id`, `User_nama`, `User_prodi`, `User_email`, `User_pin`, `User_tag`, `User_koin`, `User_foto`, `User_nokoin`, `User_level_id`, `User_lab_id`) VALUES (&#039;123456&#039;, &#039;Yustina&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;12&#039;, &#039;10&#039;, &#039;&#039;, &#039;&#039;, &#039;2&#039;, &#039;1&#039;), (&#039;654321&#039;, &#039;Maria&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;13&#039;, &#039;10&#039;, &#039;&#039;, &#039;&#039;, &#039;2&#039;, &#039;2&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="peminjamanalat" targettable="lab">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `lab`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="peminjamanalat" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `user` ADD INDEX(`User_lab_id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="peminjamanalat" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `user` (`User_id`, `User_nama`, `User_prodi`, `User_email`, `User_pin`, `User_tag`, `User_koin`, `User_foto`, `User_nokoin`, `User_level_id`, `User_lab_id`) VALUES (&#039;6543210&#039;, &#039;Maria&#039;, &#039;&#039;, &#039;&#039;, &#039;&#039;, &#039;13&#039;, &#039;10&#039;, &#039;&#039;, &#039;&#039;, &#039;2&#039;, &#039;2&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="peminjamanalat" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="peminjamanalat" targettable="pinjam">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `pinjam`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="peminjamanalat" targettable="user">
                            <div class="action_content">
