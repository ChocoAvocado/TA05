                                ...
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="nama_loker"
                                                    id="nama_loker" placeholder="Nama Loker" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="merek_barang"
                                                    id="merek_barang" placeholder="Merk Barang" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="jumlah_barang"
                                                    id="jumlah_barang" placeholder="Jumlah Barang" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="custom-file">
                                                    <input type="file" name="file" class="custom-file-input"
                                                        id="customFile" value="<?=$img_barang?>" autocomplete="off">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <button type="submit" name="simpan_tambah_barang"
