                                ...
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                            <input type="text" class="form-control" name="nama_loker" id="nama_loker" placeholder="Nama Loker">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label  class="col-md-4 col-form-label"> Merk Barang</label>
                                            <div class="col-md-8">
                                            <input type="text" class="form-control" name="merek_barang" id="merek_barang" placeholder="Merk Barang">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="custom-file">
                                                    <input type="file" name="qr" class="custom-file-input" id="cFile">
                                                    <label class="cu-file-label" for="cFile"> upload gambar</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
