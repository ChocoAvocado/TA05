                                ...
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                            <input type="text" class="form-control" name="nama_loker" id="nama_loker" placeholder="Nama Loker"autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label  class="col-md-4 col-form-label"> Merk Barang</label>
                                            <div class="col-md-8">
                                            <input type="text" class="form-control" name="merek_barang" id="merek_barang" placeholder="Merk Barang"autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="custom-file">
                                                    <input type="file" name="file" class="custom-file-input" id="customFile" value="<?=$img_barang?>" autocomplete="off">
                                                    <label class="custom-file-label" for="customFile"> upload gambar</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label  class="col-md-4 col-form-label"> Aksi </label>
                                            <div class="col-md-8">
                                                <button type="submit" name="simpan_tambah_barang" class="btn btn-primary"> Simpan </button>
                                            </div>
                                        </div>
