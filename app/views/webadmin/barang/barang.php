                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form method="get" action=""
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Scan Barcode"
                                    ...
                                    <form class="form-inline mr-auto w-100 navbar-search">
                                        <div class="input-group">
                                            <input type="text" class="form-control bg-light border-0 small"
                                                placeholder="M" aria-label="Search" aria-describedby="basic-addon2">
                                            <div class="input-group-append">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input type="text" name="MerekBarang"
                                                                        value="<?=$MerekBarang?>" class="form-control"
                                                                        autocomplete="off">
                                                                    <br>
                                                                    Jumlah Barang
                                                                    ...
                                                                    <br>
                                                                    Loker
                                                                    <input type="text" name="Loker" value="<?=$Loker?>"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <div class="custom-file">
                                                                                <input type="file" name="file" value="<?=$img_barang?>"
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="post">
                                                                        ...
                                                                        <div class="modal-top mt-1 mb-2" align="right">
                                                                            <button type="submit" name="hapusdatabarang"
